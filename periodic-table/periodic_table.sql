...
--
-- Name: elements un_properties_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT un_properties_name UNIQUE (name);


--
-- Name: elements un_properties_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT un_properties_symbol UNIQUE (symbol);
